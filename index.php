                        ...
                        <div class="jumbotron">
                            <div class="row">
                                <div class="container col-lg-6 col-md-6 col-sm-7">
                                    ...
                                    <p class="lead"><?php _e( 'I Freelance as a Web dessigner and developer. I showcase stuff, curate usefull tools for Web professionals. Feel free to check out my Blog &amp; Portfolio.', 'wdg1' ); ?></p>
                                </div>
