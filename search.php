        ...
        <div class="row">
            ...
            <div class="content-area col-md-8 content-area" id="primary">
                <main class="site-main" id="main">
                    ...
                    </article><?php endwhile; ?><?php else : ?><p class="lead text-muted"><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'wdg1' ); ?></p><?php endif; ?>
