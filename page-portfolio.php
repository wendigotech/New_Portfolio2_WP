...
<<<<<<< HEAD
        ...
        <main class="mt-5 pt-5">
            ...
            </div><?php else : ?><p><?php _e( 'Sorry, no posts matched your criteria.', 'wdg1' ); ?></p><?php endif; ?>
        </main>
=======
                        <symbol id="icon-arrow" viewbox="0 0 24 24">
                            <title><?php _e( 'arrow', 'wdg1' ); ?></title>
                        ...
                        <div class="slideshow">
                            ...
                            <div class="slide">
                                <div class="slide__img-wrap"><div class="slide__img" style="background-image:url('https://images.unsplash.com/photo-1504495619773-d6762510888b?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjIwOTIyfQ');"></div>
...
>>>>>>> 6e407106b759805af1edaf853ce9b78db424b481
    </div>
</div>
